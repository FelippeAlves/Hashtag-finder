async function searchTweets(word) {
    return fetch(`https://cors.eu.org/https://api.twitter.com/2/tweets/search/recent?query=${word}&tweet.fields=created_at&expansions=author_id&user.fields=profile_image_url`, { 
        method: 'GET',
        headers: {
